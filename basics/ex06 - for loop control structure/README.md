...
Demonstration of the for loop control structure and some basic demonstrations of the modern looping constructs. These modern constructs are further explained in dedicated examples.
```c++
#include <iostream>
#include <vector>
#include <algorithm>
